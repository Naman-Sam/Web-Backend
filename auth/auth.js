...
const sendOTPEmail = async (email, otp, purpose) => {
    ...
    <p style="font-size: 14px; color: #666;">We appreciate your trust in <strong>Seema Enterprises</strong>. If you have any questions, feel free to contact us.</p>
    
    <!-- Footer -->
    <div style="font-size: 12px; color: #999; margin-top: 30px; border-top: 1px solid #ddd; padding-top: 10px;">
        <p style="margin: 0;">Seema Enterprises | Contact: byweighthandloom@gmail.com</p>
